...
public class VarViewerToolWindow implements ToolWindowFactory, ProjectComponent {
    ...
    // do not create ToolWindow twice
    private Boolean initialized = false;

    private static Logger logger = Logger.getInstance(VarViewerToolWindow.class);

    @Override
    public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
        if (initialized) {
            logger.warn(String.format("%s already initialised!",
        ...
        toolWindow.getComponent().add(createViewerPanel());
